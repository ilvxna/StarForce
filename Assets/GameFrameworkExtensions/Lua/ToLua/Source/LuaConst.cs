...
{
    public static string luaDir = Application.dataPath + "/GameFrameworkExtensions/Lua/ToLua/Lua";                //lua逻辑代码目录
    public static string toluaDir = Application.dataPath + "/GameFrameworkExtensions/Lua/ToLua/ToLua/Lua";        //tolua lua文件目录
